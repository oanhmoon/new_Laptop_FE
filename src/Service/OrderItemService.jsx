...
export class OrderItemService extends baseService {
    ...
    rejectRefund = (id) => this.put(`api/v1/order/reject/refund/${id}`, {});
    acceptReturn = (id) => this.put(`api/v1/order/accept/return/${id}`, {});
    verifyReturn = (id) => this.put(`api/v1/order/verify/return/${id}`, {});
