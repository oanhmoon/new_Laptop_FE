...
const OrderManagement = () => {
  ...
  const exportInvoiceToPdf = (order) => {
    ...
    doc.text("OHT STORE", 105, 30, { align: "center" });
    doc.text("Địa chỉ: Trần Phú, Hà Đông, Hà Nội", 105, 35, { align: "center" });
    doc.text("Điện thoại: 1800-123-4567 - Email: info@ohtstore.com", 105, 40, { align: "center" });
